...
# SPACES
# export COLOR_SPACE_SELECTED_BG=$COLOR_DRACULA_LINCOLN #$COLOR_DRACULA_LINCOLN
# export COLOR_SPACE_SELECTED_SPACE_NO=$COLOR_BLACK
# export COLOR_SPACE_SELECTED_ICON=$COLOR_BLACK

# export COLOR_SPACE_BG=$COLOR_DRACULA_LINCOLN #$COLOR_DRACULA_LINCOLN
# export COLOR_SPACE_SPACE_NO=$COLOR_DRACULA_BLACK_TEXT_LIGHT
# export COLOR_SPACE_ICON=$COLOR_DRACULA_BLACK_TEXT_LIGHT

export COLOR_SPACE_SELECTED_BG=$COLOR_DRACULA_MORBIUS #$COLOR_DRACULA_LINCOLN
export COLOR_SPACE_SELECTED_SPACE_NO=$COLOR_DRACULA_TEXT_DARK_BG
export COLOR_SPACE_SELECTED_ICON=$COLOR_DRACULA_TEXT_DARK_BG

export COLOR_SPACE_BG=$COLOR_DRACULA_MORBIUS #$COLOR_DRACULA_LINCOLN
...
# RIGHT_AREA
export COLOR_RIGHT_AREA_BG=$COLOR_DRACULA_GREY
export COLOR_RIGHT_AREA_TEXT=$COLOR_DRACULA_TEXT_DARK_BG
...
# VOLUME
export COLOR_VOLUME_LOW=$COLOR_STATS
...
# UTILS RIGHT
export COLOR_UTILS_RIGHT_BG=0xff8e5ebc
export COLOR_UTILS_RIGHT_SEPARATOR2=0xff8e5ebc
export COLOR_UTILS_RIGHT_EXTRA_SEPARATOR=$COLOR_DRACULA_PURPLE

# AIRPODS
export COLOR_HEADPHONES_WARNING=$COLOR_DRACULA_LINCOLN
export COLOR_HEADPHONES_CRITICAL=$COLOR_WARNING
export COLOR_HEADPHONES=$COLOR_STATS

# AIRPODS CASE
export COLOR_HEADPHONES_CASE_WARNING=$COLOR_DRACULA_LINCOLN
export COLOR_HEADPHONES_CASE_CRITICAL=$COLOR_WARNING
export COLOR_HEADPHONES_CASE=$COLOR_STATS