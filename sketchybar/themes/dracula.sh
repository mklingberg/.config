...
export COLOR_DRACULA_TEXT_DARK_BG=0xeef8f8f2
export COLOR_DRACULA_TEXT_DARK_BG_LIGHT=0x66f8f8f2
export COLOR_DRACULA_VAN_HELSING=0xff5bf5f5
export COLOR_DRACULA_BLADE=0xff64f859
export COLOR_DRACULA_MORBIUS=0xfff87359
...
export COLOR_SPACE_SELECTED_BG=$COLOR_DRACULA_BUFFY #$COLOR_DRACULA_LINCOLN
export COLOR_SPACE_SELECTED_SPACE_NO=$COLOR_STATS
export COLOR_SPACE_SELECTED_ICON=$COLOR_STATS

export COLOR_SPACE_BG=$COLOR_DRACULA_BUFFY #$COLOR_DRACULA_LINCOLN
...
# RIGHT_AREA
export COLOR_RIGHT_AREA_BG=$COLOR_DRACULA_LIGHT_BG
export COLOR_RIGHT_AREA_TEXT=$COLOR_DRACULA_BLACK
