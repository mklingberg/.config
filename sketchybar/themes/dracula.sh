...
export COLOR_BAR_BG=$COLOR_OVERLAY #$COLOR_GLASS
...
export COLOR_SPOTIFY_BG=$COLOR_DRACULA_MIDDLE_GREY #0xdd414450 #$COLOR_DRACULA_MIDDLE_GREY #$COLOR_DRACULA_BLACK
export COLOR_SPOTIFY_SEPARATOR2=$COLOR_DRACULA_DARK_GRAY

# NOW PLAYING
export COLOR_NOW_PLAYING_BG=$COLOR_OVERLAY #$COLOR_DRACULA_BLACK
