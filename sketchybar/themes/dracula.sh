...
export COLOR_DRACULA_LIGHT_BG=0xbbf8f8f2
...
export COLOR_BREW_UPDATED=$COLOR_STATS #$COLOR_DRACULA_BLADE
export COLOR_BREW_OUTDATED=$COLOR_DRACULA_PRO
export COLOR_BREW_BG=$COLOR_DRACULA_MIDDLE_GREY
...
export COLOR_SPACE_SELECTED_ICON=$COLOR_DRACULA_PURPLE #0xfff8f8f2
export COLOR_SPACE_SELECTED_BG=$COLOR_UTILS_BG #0x55000000

export COLOR_SPACE_SPACE_NO=$COLOR_DRACULA_TEXT_DARK_BG
export COLOR_SPACE_SPACE_NO_BG=$TRANSPARENT
export COLOR_SPACE_ICON=$COLOR_DRACULA_TEXT_DARK_BG
...
export COLOR_SPOTIFY_BG=$COLOR_DRACULA_MIDDLE_GREY #$COLOR_DRACULA_BLACK
